    ...
    $.extend(Buttons.prototype, {
        ...
        _resolveExtends: function (conf) {
            ...
            while (conf && conf.extend) {
                ...
                // them so they are list that is combined from core extended buttons
                ...
                // Although we want the `conf` object to overwrite almost core of
        ...
        collection: {
            ...
            action: function (e, dt, button, config) {
                ...
                setTimeout(function () {
                    ...
                    // listener below. An empty function here is core that is
...
// types (DRY)
    ...
    var _exportData = function (dt, inOpts) {
        ...
        // to the selected rows. If no rows are selected, core rows will be exported. Specify
