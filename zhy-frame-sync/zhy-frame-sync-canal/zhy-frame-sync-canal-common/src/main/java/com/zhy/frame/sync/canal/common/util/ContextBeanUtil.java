package com.zhy.frame.sync.canal.common.util;/**
 * 描述:
 * 包名:com.zhy.bigdata.canal.redis.util
 * 版本信息: 版本1.0
 * 日期:2019/7/18
...
import com.zhy.frame.sync.canal.common.listener.DataHandEventListener;
...
public class ContextBeanUtil {
     ...
     * @throws
     * @return: java.util.List<com.zhy.frame.sync.canal.common.vo.ListenerPointVo>
     * @author: lvmoney /XXXXXX科技有限公司
