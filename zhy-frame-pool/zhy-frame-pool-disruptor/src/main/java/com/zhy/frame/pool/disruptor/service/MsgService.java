package com.zhy.frame.pool.disruptor.service;/**
 * 描述:
 * 包名:com.zhy.frame.pool.disruptor.service
 * 版本信息: 版本1.0
 * 日期:2020/4/26
...
public interface MsgService {
     ...
     * @throws
     * @return: com.lmax.disruptor.dsl.Disruptor<com.zhy.frame.pool.disruptor.vo.MsgEvent>
     * @author: lvmoney /XXXXXX科技有限公司
     ...
     * @param msgEvent:
     * @throws
     * @return: com.zhy.frame.pool.disruptor.producer.MsgEventProducer
     * @author: lvmoney /XXXXXX科技有限公司
     * @date: 2020/4/27 9:53
     */
