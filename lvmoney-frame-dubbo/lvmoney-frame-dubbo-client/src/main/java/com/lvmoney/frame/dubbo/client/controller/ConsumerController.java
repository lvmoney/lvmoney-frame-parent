package com.lvmoney.frame.dubbo.client.controller;/**
 * 描述:
 * 包名:com.lvmoney.frame.dubbo.client.function
 * 版本信息: 版本1.0
 * 日期:2019/12/27
...
import com.lvmoney.frame.dubbo.client.cloud.ICommonServiceClient;
