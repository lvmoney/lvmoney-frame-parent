package com.lvmoney.frame.office.pdf.util;/**
 * 描述:
 * 包名:com.lvmoney.frame.office.pdf.util
 * 版本信息: 版本1.0
 * 日期:2021/10/13
 ...
 * @version:v1.0 2021/10/13 21:44
 */
public class PdfUtils {
    private String office_path = "D://";
    ...
    public static void main(String[] args) {
        PdfUtils o = new PdfUtils();
        o.office2pdf("c2.docx", "data");
    }
...
//            logger.info(doc);
            ...
            int time2 = (int) ((date2 - date) / 1000);
            System.out.println(time2);
            int time = (int) (date2 - date);
