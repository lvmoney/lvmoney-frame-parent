...
public abstract class BaseRedisService implements CacheCommonService {
     ...
     * @param corePage: 分页信息
     * @param key:      redis key
     * @return: com.lvmoney.core.vo.CorePage
     * @author: lvmoney /四川******科技有限公司
     * @date: 2019/9/9 19:43
     */
    public abstract CorePage getListPage(CorePage corePage, String key);
     ...
     * @date: 2019/9/9 19:47
     */
    public abstract CorePage getValueByKey(CorePage corePage, String key);
     ...
     */
    @Override
    public abstract Map<Object, Object> getMap(String key);
