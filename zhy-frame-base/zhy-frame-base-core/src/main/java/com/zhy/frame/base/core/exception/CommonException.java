...
public interface CommonException {
    ...
    enum Proxy implements ExceptionType {
         ...
         * rabbitmq注解不存在
         */
        RABBITMQ_PROVIDER_DYNAMIC_NOT_EXIST(ExceptionCodeLevel.CORE.getValue() + 120, "rabbitmq @DyProviderService bean not exist"),

        /**
         * kafka注解不对
         */
        KAFKA_PROVIDER_DYNAMIC_NOT_EXIST(ExceptionCodeLevel.MQ.getValue() + 121, "kafka @DyProviderService bean not exist"),
