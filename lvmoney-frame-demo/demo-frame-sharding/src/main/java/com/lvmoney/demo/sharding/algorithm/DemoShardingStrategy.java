...
@NoArgsConstructor
@Service
public class DemoShardingStrategy implements HintShardingAlgorithm<String> {
    /**
     * 支持多分片键
     */
    @Getter
    ...
    public DemoShardingStrategy(final HintShardingStrategyConfiguration hintShardingStrategyConfig) {
