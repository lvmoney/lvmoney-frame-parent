package com.lvmoney.demo.sentinel.client.controller;/**
 * 描述:
 * 包名:com.lvmoney.frame.ops.sentinel.function
 * 版本信息: 版本1.0
 * 日期:2020/4/8
...
import com.lvmoney.demo.sentinel.client.client.IDemoProviderClient;
