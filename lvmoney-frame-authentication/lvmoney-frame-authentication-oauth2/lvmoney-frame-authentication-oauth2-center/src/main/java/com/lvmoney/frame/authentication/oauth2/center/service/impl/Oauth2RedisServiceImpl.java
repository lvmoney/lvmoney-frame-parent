...
import com.lvmoney.frame.authentication.oauth2.center.vo.resp.AuthorizationRespVo;
...
public class Oauth2RedisServiceImpl implements Oauth2RedisService {
    ...
    private AuthorizationVo authorizationRespVo2AuthorizationVo(AuthorizationRespVo authorizationRespVo) {
        ...
        com.lvmoney.frame.authentication.oauth2.center.vo.Authentication fAuthorization = authorizationRespVo.getAuthentication();
