...
{
	jclass imageClazz = getClass(env, "com/lvmoney/frame/ai/seetaface/jni/vo/SeetaImageData");
...
static jobject toSeetaFaceInfoArray(JNIEnv *env, SeetaFaceInfoArray seetaFaceInfoArray) {
	jclass infosClazz = getClass(env, "com/lvmoney/frame/ai/seetaface/jni/vo/SeetaFaceInfoArray");
	// �½�����
	jobject infos = newObject(env, infosClazz);
	// ����size
	setInt(env, infos, infosClazz, "size", seetaFaceInfoArray.size);
	// ����data
	jclass infoClazz = getClass(env, "com/lvmoney/frame/ai/seetaface/jni/vo/SeetaFaceInfo");
	...
	jfieldID posField = env->GetFieldID(infoClazz, "pos", "Lcom/lvmoney/frame/ai/seetaface/jni/vo/SeetaRect;");
	...
	jfieldID dataField = env->GetFieldID(infosClazz, "data", "[Lcom/lvmoney/frame/ai/seetaface/jni/vo/SeetaFaceInfo;");
