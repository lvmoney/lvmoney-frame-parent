...
if __name__ == '__main__':
    training_dir = "D:/data/images/data/faces/training"  # 训练集地址
    serialNo = '10000'
    train(training_dir, serialNo)
    res = r'D:/data/images/data/faces/training/s1/2.bmp'
    target = r'D:/data/images/data/faces/training/s1/1.bmp'
