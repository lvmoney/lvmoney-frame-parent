package com.lvmoney.frame.ai.isolationforest.ro;/**
 * 描述:
...
@AllArgsConstructor
@NoArgsConstructor
public class IsolationForestInputRo implements Serializable {
    private static final long serialVersionUID = -2157099242445953128L;
    /**
     * 数据分类
     */
