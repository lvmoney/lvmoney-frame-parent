...
import com.lvmoney.frame.core.vo.ByteInputFileVo;
import com.lvmoney.frame.core.vo.ByteOutputFileVo;
import com.lvmoney.frame.core.vo.FileVo;
...
public class EncryptFileUtil {
    private static final Logger LOGGER = LoggerFactory.getLogger(EncryptFileUtil.class);
    /**
     * 默认长度
     */
     ...
     * @throws
     * @return: com.lvmoney.frame.core.vo.ByteOutputFileVo
     * @author: lvmoney /XXXXXX科技有限公司
     * @date: 2020/5/7 14:58
     */
