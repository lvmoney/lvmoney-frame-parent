...
/**
 * @describe：接收1个参数，如果第一个参数值是错误数字（NaN、无限）返回0
 * @author: lvmoney /四川******科技有限公司
 * @version:v1.0 2019/11/19 16:38
 */
@MathFunction(name = "DefFalse")
public class DefFalse extends MultiFunction {
    @Override
    public double eval(List<Expression> args) {

        return NaNDef.nanDef(getDouble(args.get(0)), 0);
    }
