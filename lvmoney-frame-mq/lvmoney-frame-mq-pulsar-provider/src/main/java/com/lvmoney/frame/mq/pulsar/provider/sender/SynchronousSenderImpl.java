 ...
 * @version:v1.0 2021/5/25 13:51
 */
@MqService(MqConstant.PULSAR_TYPE_SYN)
public class SynchronousSenderImpl implements MqSendService {
    ...
    public boolean send(MessageVo msg) {
        producer.sendAsync(frameMqName + BaseConstant.CONNECTOR_UNDERLINE +PulsarConstant.SIMPLE_QUEUE_NAME, msg);
        return false;
    }
}
