package com.lvmoney.frame.autocode.db.util;/**
 * 描述:
 * 包名:com.lvmoney.frame.autocode.db.service.impl
 * 版本信息: 版本1.0
 * 日期:2020/6/18
...
import com.lvmoney.frame.autocode.common.enums.AutocodeConstant;
...
import static com.lvmoney.frame.autocode.db.enums.DbPkgEnum.EXTERNAL_CONTROLLER;
import static com.lvmoney.frame.autocode.db.enums.DbPkgEnum.INTERNAL_CONTROLLER;
...
public class AutocodeDbUtil {
    ...
    private static DataSourceConfig getDataSourceConfig(DbVo dbVo) {
        ...
        dsc.setUrl("jdbc:mysql://" + dbVo.getDbIp() + ":" + dbVo.getDbPort() + "/" + dbVo.getDbName() + "?useUnicodle=true&characterEncoding=utf8&useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true");
        return dsc;
    }
