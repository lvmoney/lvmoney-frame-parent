package com.lvmoney.frame.newsql.clickhouse.sink.constant;/**
 * 描述:
 * 包名:com.lvmoney.frame.newsql.clickhouse.config
 * 版本信息: 版本1.0
 * 日期:2020/6/26
...
public class ClickHouseSinkConstant {
     ...
     * 默认的端口
     */
    public static final String DEFAULT_SYS_NAME = "istio-ingressgateway";
     ...
     */
    public static final String DEFAULT_CACHE_DATE_KAFKA = "LATEST_KAFKA_DATE";

    /**
     * 缓存中用来存k8s pod日志消费的时间key 用来记录最近同步时间
     */
    public static final String DEFAULT_CACHE_DATE_K8S_POD = "LATEST_K8S_POD_DATE";
