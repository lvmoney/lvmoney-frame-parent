 ...
 */
public class PkgScanUtil {
    private static final Logger LOGGER = LoggerFactory.getLogger(PkgScanUtil.class);
    /**
     * 包名通配符
     */
    ...
    public static void main(String[] args) {
        ...
        PkgScanUtil scanPackage = new PkgScanUtil();
        scanPackage.addPackage(PkgScanUtil.class.getPackage().getName());
