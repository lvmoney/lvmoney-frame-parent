package com.zhy.frame.core.exception;

import com.zhy.frame.core.enums.ExceptionCodeLevel;

import static com.zhy.frame.core.constant.BaseConstant.SUCCESS_DEFAULT_CODE;
...
public interface CommonException {
    ...
    enum Proxy implements ExceptionType {
         ...
         * 关闭所有定时任务报错
         */
        QUARTZ_JOB_CLOSE_ALL_ERROR(ExceptionCodeLevel.CORE.getValue() + 100, "quartz close all job error"),
        /**
         * 定时任务执行报错
         */
