package com.lvmoney.frame.log.server.aspect;/**
 * 描述:
...
import com.lvmoney.frame.log.common.exception.LogException;
import com.lvmoney.frame.log.server.annotation.ControllerLog;
import com.lvmoney.frame.log.server.annotation.NotLog;
import com.lvmoney.frame.log.server.service.LogService;
import com.lvmoney.frame.log.server.vo.ControllerVo;
import com.lvmoney.frame.log.server.vo.LogVo;
import com.lvmoney.frame.log.server.vo.ThrowableVo;
...
public class LogAspect {
     ...
     */
    @Pointcut("@annotation(com.lvmoney.frame.log.server.annotation.ControllerLog)")
