package com.lvmoney.frame.db.mysql.rw.config;/**
 * 描述:
 * 包名:com.lvmoney.mysql.separate.handler
 * 版本信息: 版本1.0
 * 日期:2019/9/6
 * Copyright 四川******科技有限公司
 */
...
import com.lvmoney.frame.db.mysql.rw.enums.DbType;
import com.lvmoney.frame.db.mysql.rw.properties.DatabaseConfigProp;
import com.lvmoney.frame.db.mysql.rw.properties.DruidConfigProp;
import com.lvmoney.frame.db.mysql.rw.vo.DatabaseConfig;
import com.lvmoney.frame.db.mysql.rw.vo.FrameMasterSlaveRule;
...
public class DataSourceConfig {
    ...
    private DataSource buildDataSource() {
        ...
        List<String> salveList = new LinkedList<>();
